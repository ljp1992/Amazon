...
import time
from openerp.http import request as oe_request
    ...
    def make_request( self, extra_data, method="GET", **kwargs ):
        ...
        try:
            ...
            if response.status_code!=200:
                self.parsed_response_error = DictWrapper( response.content, "Error" )
...
class Feeds( MWS ):
    ...
    def submit_feed( self, feed, feed_type, marketplaceids=None,
                    content_type="text/xml", purge='false', instance_id=False ):
        """
        ...
        if hasattr(oe_request,'env'):
            ...
            vals = {'message':feed, 'feed_result_id':last_feed_submission_id,
...
class Reports( MWS ):
    ...
    def request_report( self, report_type, start_date=None, end_date=None, marketplaceids=(),instance_id=False):
